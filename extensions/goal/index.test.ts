...
test("renders the goal overlay as a compact summary", () => {
	...
	const lines = renderGoalOverlayBody({
		objective: "Continue the vendor-neutral browser capture backend for Zeno while preserving parity with HTTP-only captures across discovery, filtering, assets, retries, lifecycle metadata, observability, and replayable WARC/MCDX output.",
