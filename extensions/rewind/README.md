...
```
/rewind
  1. Add retry logic to the fetch wrapper
  2. Wire up the new config loader
  3. Fix the test fixtures
  ▶ 4. Refactor the auth middleware
```

## Commands

- `/rewind` — fork from an earlier user prompt
